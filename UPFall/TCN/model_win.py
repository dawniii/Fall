...
for train_index, test_index in floder.split(reshaped_segments):
    ...
    if(k_fold_num==1):
        checkpoint_save_path ="E:/Fall/UPFall/TCN/checkpoint/UPFall1.ckpt"
        if os.path.exists(checkpoint_save_path + '.index'):
            print('-------------load the model-----------------')
            model_TCN.load_weights(checkpoint_save_path)
    if(k_fold_num==2):
        checkpoint_save_path ="E:/Fall/UPFall/TCN/checkpoint/UPFall2.ckpt"
        if os.path.exists(checkpoint_save_path + '.index'):
            print('-------------load the model-----------------')
            model_TCN.load_weights(checkpoint_save_path)
    if(k_fold_num==3):
        checkpoint_save_path = "E:/Fall/UPFall/TCN/checkpoint/UPFall3.ckpt"
        if os.path.exists(checkpoint_save_path + '.index'):
            print('-------------load the model-----------------')
            model_TCN.load_weights(checkpoint_save_path)
    ...
    if(k_fold_num==1):
        plt.savefig('E:/Fall/UPFall/TCN/figure/k1-TCN-C.png',bbox_inches='tight')
    if(k_fold_num==2):
        plt.savefig('E:/Fall/UPFall/TCN/figure/k2-TCN-C.png',bbox_inches='tight')
    if(k_fold_num==3):
        plt.savefig('E:/Fall/UPFall/TCN/figure/k3-TCN-C.png',bbox_inches='tight')
    plt.close()
